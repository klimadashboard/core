<script>
    ...
    <div
        ...
        <g id="visualisation" transform={`translate(${margin.left}, ${margin.top})`} class="text-gray-500 ">
        ...
        <g transform={`translate(${xScale(datapoint.x)}, ${yScale(datapoint.y)})`} in:fade="{{delay: i * 10}}" class="">
            {#if i == data.length - 1}
