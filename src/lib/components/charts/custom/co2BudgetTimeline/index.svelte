	...
	const sources = [
		{
			index: 2,
			label:
				"Daten: Gütschow et al. PRIMAP / <a href='https://datacube.uba.de/vis?lc=de&fs[0]=Themen,0%7CKlima%23CLIMATE%23&pg=0&fc=Themen&bp=true&snb=14&df[ds]=ds-dc-release&df[id]=DF_CLIMATE_EMISSIONS_GHG_TRENDS_KSG&df[ag]=UBA&df[vs]=1.0&dq=.A.MT.CO2.TOTAL&pd=1990,2024&to[TIME_PERIOD]=false&ly[cl]=TIME_PERIOD&vw=tb'>UBA</a>"
		},
		{
			index: 3,
			label:
		...
		<div slot="foreground" class="co2b-foreground">
			<section>
				<div class="co2b-section-background">
					...
					<h2 class="text-2xl md:text-3xl text-energy" in:fade={{ delay: 5000 }}>
						...
						<nobr>1,5 °C-Grenze</nobr> überschritten.
					</h2>
			...
			<section>
				<div class="co2b-section-background">
					<p class="text-lg">
						...
						hat der Sachverständigenrat für Umweltfragen (SRU) ein maximales CO2-Budget für
						Deutschland berechnet. Hierfür verwendete der SRU den Anteil Deutschlands an der
					...
					{#if selectedBudgetYear == budgets[budgets.length - 1]}
						<div class="text-energy transition">
							<p class="text-lg mt-4">
								Mitte 2022 hat Deutschland sein faires CO<sub>2</sub>-Budget überschritten.
							</p>
			...
			<section>
				<div class="co2b-section-background text-lg space-y-2 mb-80 mt-80 md:mt-0">
					...
					<p>
						Mit der Überschreitung des nationalen CO2-Budgets ist es wichtig, <strong
							>Deutschlands Rolle in der Welt</strong
						>
						kritisch zu beleuchten. Als Land mit besonderer
						<strong>historischer Verantwortung</strong>
						sollte sich Deutschland und die gesamte Europäische Union klar zu ihrer Verantwortung für
						Schäden und Verluste bekennen. Im Sinne der Klimagerechtigkeit sollte eine
						<strong>Erhöhung</strong>
						internationaler Klimafinanzierung angedacht werden. Zukünftig könnte sich auch das Völkerrecht
						weiterentwickeln, wodurch eine Überschreitung des CO2-Budgets zum Haftungsrisiko wird.
					</p>
					<p>
						Kontrovers diskutiert werden <strong>alternative Mechanismen</strong>, um das nationale
						CO<sub>2</sub>-Budget noch einzuhalten. Durch technologische Lösungen wie Carbon Dioxide
						Removal (CDR) sollen Negativemissionen ermöglicht werden, indem CO<sub>2</sub> aus der
						Atmosphäre entfernt wird. Diese Technologien haben allerdings noch keinen Reifegrad
						erreicht, der großflächige Anwendung sinnvoll erscheinen lässt. Ein anderer Vorschlag
						ist, Emissionsminderungen im Ausland quasi als Ausgleich für Deutschlands
						Überschreitungen zu finanzieren. Oft dienen diese Argumente als
						<strong>Ablenkung von wirksamen und bereits umsetzbaren Klimaschutzmaßnahmen</strong> und
						widersprechen den Grundsätzen der Klimagerechtigkeit. Es existieren ausreichend Technologien
						für eine umfassende Dekarbonisierung in Deutschland.
					</p>
					<p>
						...
						die Erhitzung zunehmend schwieriger, die Gefahr Kipppunkte zu überschreiten steigt und die
						unbewohnbaren Bereiche des Planeten (durch Meeresspiegelanstieg, Dürre, fehlende Frischwasserversorgung
						oder andere Faktoren) werden größer.
					</p>
				</div>
			</section>
			<section>
