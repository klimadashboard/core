...
<main class=" -mb-16">
	<div class="md:container relative">
		<div class="absolute top-20 left-4 right-4 border-t border-gray-300 flex items-center">
			<p
				class="text-gray-400 text-xs sm:text-sm uppercase tracking-wide text-center inline-block mx-auto bg-white dark:bg-gray-950 -translate-y-2 sm:-translate-y-3 px-2"
			>
