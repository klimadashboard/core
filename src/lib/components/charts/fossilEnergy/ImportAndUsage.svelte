<script>
	...
	import UsageChart from '$lib/components/charts/fossilEnergy/UsageChart.svelte';
	import HistoricalUsage from '$lib/components/charts/fossilEnergy/HistoricalUsage.svelte';
	import RegionalUsage from '$lib/components/charts/fossilEnergy/RegionalUsage.svelte';
	import Switch from '$lib/components/Switch.svelte';
	import UnitExplainer from '$lib/components/charts/fossilEnergy/UnitExplainer.svelte';
