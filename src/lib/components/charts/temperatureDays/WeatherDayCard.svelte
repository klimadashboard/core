...
{#if chartWidth && chartHeight}
    ...
    >
        ...
        <text x=15 y=16 dominant-baseline="hanging" class="text-2xl font-medium fill-white">{title}</text>
        ...
        <svg width="45" height="23" viewBox="0 0 45 23" fill="none" xmlns="http://www.w3.org/2000/svg" x={15} y={chartHeight - 38}>
