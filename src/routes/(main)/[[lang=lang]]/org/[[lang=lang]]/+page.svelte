...
<style>
	/* ── Handwriting font ── */
	/* Caveat is self-hosted from /static/fonts (variable font, wght 400–700) —
	   never load it from a font CDN. */
	@font-face {
		font-family: 'Caveat';
		font-style: normal;
		font-weight: 400 700;
		font-display: swap;
		src: url('/fonts/caveat-v23-latin.woff2') format('woff2');
		unicode-range:
	...
	@font-face {
		...
		font-weight: 400 700;
		font-display: swap;
		src: url('/fonts/caveat-v23-latin-ext.woff2') format('woff2');
		unicode-range:
