	...
	$: sections = [
		{
			title: 'Emissionen',
			countries: ['at', 'de'],
			description: `Die Reduktion von Treibhausgasemissionen ist von entscheidender Bedeutung. Doch wie sieht es in deiner Region aus? Erkunde, wie sich die Emissionen auf verschiedene Sektoren verteilen und wie sich diese über die letzten Jahre verändert haben.`,
			id: 'emissions',
