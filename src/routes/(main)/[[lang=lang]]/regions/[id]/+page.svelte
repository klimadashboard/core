	...
	const sections = [
		{
			title: 'Emissionen',
			countries: ['at', 'de'],
			description: `Der Reduktion von Treibhausgasemissionen ist von entscheidender Bedeutung. Doch wie sieht es in deinem Bundesland aus? Erkunde, wie sich die Emissionen auf verschiedene Sektoren verteilen und wie sich diese über die letzten Jahre verändert haben. `,
			id: 'emissions',
