...
<div
	class="rounded-xl overflow-hidden relative cursor-pointer border border-current/10 h-full"
...
>
	{#if center}
		<StaticMap {center} zoom={population > 100000 ? 11 : 14} {outline} />
	{/if}
	<div
	...
	<div class="p-4 flex flex-col h-full absolute bottom-0 left-0 right-0 pointer-events-none">
		<div class="mt-auto">
			...
			<span class="text-lg font-bold leading-tight">{exploreMapLabel}</span>
		</div>
	</div>
</div>
