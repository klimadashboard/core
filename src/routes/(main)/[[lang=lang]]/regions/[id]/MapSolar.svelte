...
<div class="absolute top-4 left-4 z-40 pointer-events-auto flex flex-col gap-2">
	...
	>
		<select
			...
			class="appearance-none text-sm bg-transparent cursor-pointer"
		>
	...
	{#if legendSteps.length}
		<div
			class="bg-white dark:bg-gray-800 text-xs rounded-lg shadow-lg p-3 border border-gray-200 dark:border-gray-700"
		>
			<div class="font-semibold mb-2">Solarleistung (kWp/km²)</div>
